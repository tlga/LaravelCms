          ...
          <div class="row">
            <div class="col-md-4">
              @foreach($post as $p)
                ...
                <div class="widget widget-post image-featured">
                  <a href="{{ route('blog')."/".$p->slug."/".$p->post_slug }}">
                    <div class="widget-post-img">
                    <img src="{{  asset("/images/full_size/" . \App\Logic\Functions\Functions::getImage($p->post_featured)) }}" class="img-fluid">
                  </div>
