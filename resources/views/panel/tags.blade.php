	...
	<div class="m-content">
			<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
							<form method="POST" action="{{ URL::Route('admin.savedTags') }}">
										...
										<div class="m-form m-form--fit m-form--label-align-right">
											<div class="m-portlet__body">
												...
												<div class="form-group m-form__group">
													...
													<input type="text" class="form-control m-input" id="categoryName" name="name" aria-describedby="text" placeholder="Etiket adı giriniz">
...
@section('Footer_Script')
	...
	<script type="text/javascript">
		...
		$(document).on('click','.postButton', function() {
			...
			ajaxPost('getContent/tags',getCategory);
		});
		...
		confirmButton('select[name=batch]','post/deleteTags',deleteCategory);
	...
	'ajax': '{{ route('admin.datatable.getTags') }}',
	'columns': [
		{name: 'name'},
		{data: 'name', name: 'name'},
	...
	e.stopPropagation();
		...
		$(document).on('click','.confirm',function() {
			...
			ajaxPost('post/deleteTags',deleteCategory,$('form#tableForm').serialize());
